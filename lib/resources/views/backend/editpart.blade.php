		...
		<div>
			...
			<div class="">
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" value="{{$part->part_name}}" name="name" required>
				</div>
		  	...
		  	<div class="form-group">
		    	...
		    	<a href="{{asset('admin/course/detail/'.$part->part_cou_id)}}" class="btn btn-warning"> Quay lại</a>
		  	</div>
		  	{{csrf_field()}}
		</form>
		</div>
