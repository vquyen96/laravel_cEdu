...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 03, 2018 lúc 11:31 AM
...
(1, 'admin', 'hs_2018-06-12_1528789965.jpeg', 'admin@cphonevn.com', '0', '$2y$10$qesMSEyDH2JGnmUmJZBSJ.OULmfFopxUFyusW2mlhgZJO1oZZxaY.', '<p>Tao l&agrave; boss</p>', 1, 0, 'dONTRHgS72fbjj2qbGvyMELoX2E9rVGHPmHASK6J7WWchDesf3QSX4gRbMce', '2018-04-04 00:03:55', '2018-06-12 07:52:45', '', ''),
(3, 'Quyến Đỗ', 'hs_2018-06-12_1528790190.jpeg', 'vquyenaaa@gmail.com', '0', '$2y$10$zTZKXihF7Pt0WcdgJGWgSucY.sQaau/SblbhP25hCBW5Qu5pdjmKi', '<p>C&aacute;i g&igrave; đ&oacute;</p>', 9, 0, 'KAt4BpMDeuLC0tDvHcjzNnUQoo8ZO7TwEw5SfGpKEzIOO2mXb2g2CvkWBoIK', '2018-04-04 00:03:55', '2018-06-19 03:20:31', '', ''),
...
(21, 'Sơn Lều', 'hs_2018-06-12_1528793763.jpeg', 'sonleu@gmail.com', '0', '$2y$10$LvV7vnRA/4KiYhdOzQvfouIQKmVNzbPpYVfWGxC36jPC73SY7mmIi', '<p>OK</p>', 8, 0, 'VTooLnscKHu87mRFtoSaphgvu1ggisQctwFSj5jTicaqJM8kN4IREA3ok2JY', '2018-04-27 02:34:54', '2018-06-19 03:20:49', '', ''),
...
(46, 'Kế Toán', 'hs_2018-06-21_1529564881.jpeg', 'ketoan@cphonevn.com', '0', '$2y$10$WQb8E3oIg7vdcd9PKD3KyeXeFqq2mYi35pL/0Ap8Id8HpQ6b9Xpma', '<p>789</p>', 3, 0, '7mwGwbEd1NR4HPlfPLaw2ZKXyhld1XGY2ZX8uB1I7mbbTFrZ3OL3IjG7CXyz', '2018-06-19 03:35:23', '2018-06-22 10:28:32', NULL, NULL),
...
(49, 'Uyên Phạm', 'user.png', 'uyenpham@gmail.com', '0', '$2y$10$E6.pTMXeTwLCYUBN90SiF.tMfHkYMaE1hOMSM8lZboggwX6iJyuUC', ' ', 9, 0, 'GbBmH1spxhx7rh7VoyOh70oKmP4XcQbVg2mtm3jS98BCcNMr82Aq4s61wPeR', '2018-06-25 04:02:48', '2018-06-25 04:02:48', NULL, NULL);
...
--
-- Đang đổ dữ liệu cho bảng `account_request`
--

INSERT INTO `account_request` (`req_id`, `req_status`, `req_acc_id`, `req_amount`, `created_at`, `updated_at`) VALUES
(5, 1, 13, 6755000, '2018-07-02 10:55:33', '2018-07-02 10:55:33'),
(6, 1, 21, 3087000, '2018-07-02 11:55:15', '2018-07-02 11:55:15');
...
(11, '1529641369.png', 'Banner Trang Chủ_Phía Trên', 'course', '2018-06-22 04:22:50', '2018-06-22 04:22:50'),
...
INSERT INTO `course` (`cou_id`, `cou_name`, `cou_slug`, `cou_img`, `cou_price`, `cou_price_old`, `cou_level`, `cou_video`, `cou_star`, `cou_content`, `cou_student`, `cou_tag`, `cou_sale`, `cou_featured`, `cou_gr_id`, `cou_tea_id`, `created_at`, `updated_at`) VALUES
...
(1, 'Ngoại ngữ', 'ngoai-ngu', '1529651245.png', '2018-04-04 02:43:14', '2018-06-22 07:07:25'),
(2, 'Maketing', 'maketing', '1529651269.png', '2018-04-04 02:43:58', '2018-06-22 07:07:49'),
(3, 'Tin học văn phòng', 'tin-hoc-van-phong', '1529651277.png', '2018-04-04 02:44:10', '2018-06-22 07:07:57'),
(4, 'Thiết kế', 'thiet-ke', '1529651761.png', '2018-04-04 18:40:43', '2018-06-22 07:16:01'),
(5, 'Công nghệ thông tin', 'cong-nghe-thong-tin', '1529651813.png', '2018-04-04 18:44:21', '2018-06-22 07:16:53'),
(6, 'Kỹ năng mềm', 'ky-nang-mem', '1529651831.png', '2018-04-04 19:39:34', '2018-06-22 07:17:11'),
(7, 'Luyện thi THPT Quốc Gia', 'luyen-thi-thpt-quoc-gia', '1529651843.png', '2018-04-18 19:05:32', '2018-06-22 07:17:23'),
(8, 'Khởi nghiệp kinh doanh', 'khoi-nghiep-kinh-doanh', '1529659019.png', '2018-04-18 19:06:35', '2018-06-22 09:17:00');
...
(20, 4, 'Hay quá', 'Học hay lắm nhưng chỉ 4 sao thôi', 3, 3, '2018-06-27 06:40:27', '2018-06-27 06:40:27');
...
--
ALTER TABLE `account_request`
  MODIFY `req_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `banner`
  MODIFY `ban_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `doc`
  MODIFY `doc_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `gift`
--
ALTER TABLE `gift`
  MODIFY `gift_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `order`
  MODIFY `ord_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `rating`
  MODIFY `rat_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
